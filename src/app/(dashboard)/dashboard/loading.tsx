      ...
      <div className="p-6 max-w-6xl mx-auto space-y-8 animate-pulse">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="card-dark p-5 space-y-3">
            <div className="h-5 bg-[var(--border)] rounded w-48" />
          ...
          <div className="card-dark p-5 space-y-3">
            ...
            <div className="progress-bar"><div className="h-full bg-[var(--border)] rounded-full w-1/2" /></div>
          </div>
        </div>
        {/* Stats skeleton */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          {[1, 2, 3, 4, 5].map(i => (
            <div key={i} className="card-dark p-4 space-y-2">
              ...
              <div className="h-2 bg-[var(--border)] rounded w-28" />
            </div>
          ))}
        </div>
      </div>
