          ...
          {[1, 2, 3].map(i => (
            <div key={i} className="card-dark p-4 flex items-center gap-3">
              ...
              <div className="space-y-1">
                ...
                <div className="h-5 bg-[var(--border)] rounded w-10" />
              </div>
            </div>
          ))}
        </div>
          ...
          <div className="flex items-end justify-center gap-4">
            {[80, 110, 60].map((h, i) => (
              <div key={i} className="flex flex-col items-center gap-2">
                ...
                <div className="h-3 bg-[var(--border)] rounded w-12" />
                <div className="w-20 bg-[var(--border)] rounded-t-lg" style={{ height: h }} />
              </div>
            ))}
          </div>
        </div>
        <div className="card-dark divide-y divide-[var(--surface-2)]">
          {[1, 2, 3, 4, 5].map(i => (
            <div key={i} className="flex items-center gap-4 p-4">
              <div className="w-6 h-4 bg-[var(--border)] rounded" />
              <div className="w-9 h-9 rounded-full bg-[var(--border)]" />
              <div className="flex-1 space-y-1">
                <div className="h-3 bg-[var(--border)] rounded w-32" />
                <div className="h-2 bg-[var(--border)] rounded w-20" />
              </div>
