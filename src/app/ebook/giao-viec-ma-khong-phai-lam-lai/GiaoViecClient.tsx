      ...
      <div className="rsc">
        ...
        <div className="wrap">
          ...
          <div className="body">
            ...
            <EbookBuyGate
              slug="ebook-giao-viec-ma-khong-phai-lam-lai"
              priceLabel={PRICE}
              loginRedirect={SLUG}
              guestText={
                <>
                  Không phải một khóa học, không phải lý thuyết. Là một buổi ngồi nghe chuyện thật của{" "}
                  <span style={nw}>mười lăm</span> năm làm nghề — những lần <span style={nw}>mắc kẹt</span>, những bài
                  học trả giá thật — mà bạn giữ được mãi, đọc lại bao nhiêu lần tùy bạn. Đăng nhập để mua trọn bộ 13
                  chương.
                </>
              }
              readyText={
                <>
                  Trọn bộ 13 chương — mô hình 5G, cuộc hội thoại bảy phút, bảy nấc quyền quyết định, bảng tra nhanh in
                  được. Thanh toán một lần · tải về ngay · đọc trên mọi thiết bị.
                </>
              }
              zaloMessage="Mua ebook Giao việc"
            />
