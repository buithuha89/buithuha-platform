...
export const metadata: Metadata = {
  ...
  description:
    "Đọc miễn phí bộ 7 câu hỏi tự nhìn vào bản thân, và tủ ebook đồng giá 99.000đ — Giao việc mà không phải làm lại (mô hình 5G) & Nghệ thuật thừa nhận sai. Chuyện thật từ mười lăm năm làm nghề, kèm cam kết hoàn tiền.",
