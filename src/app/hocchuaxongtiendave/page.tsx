...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://buithuha.com/hocchuaxongtiendave",
  },
  openGraph: {
    title: "Học Chưa Xong - Tiền Đã Về | Tự Xây Hệ Thống Bán Sản Phẩm Số Bằng AI Agent",
    description:
    ...
    type: "website",
    url: "https://buithuha.com/hocchuaxongtiendave",
    images: [
      {
        url: "https://buithuha.com/images/hocchuaxongtiendave/banner.jpeg",
        width: 1024,
        height: 576,
        alt: "Học Chưa Xong - Tiền Đã Về — Tạo sản phẩm số bán chạy nhất trong ngách của bạn · Trainer Hà Bùi",
      },
    ],
  },
};
