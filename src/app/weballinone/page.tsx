...
export const metadata: Metadata = {
  ...
  description:
    "Chia sẻ của chị Hà cho quản lý cấp trung và doanh chủ SME. Từ trải nghiệm thực — chị đã từng làm quản lý, đã từng vướng những bài học này.",
  alternates: { canonical: "https://buithuha.com/weballinone" },
  openGraph: {
    title: "Lãnh đạo & Quản lý — Hà Bùi Academy",
    description:
      "Cho quản lý cấp trung và doanh chủ SME. Chia sẻ thật từ chị Bùi Hà về nghề lãnh đạo — không phải lý thuyết.",
    type: "website",
...
const data: SiloData = {
  ...
  intro:
    "Lên quản lý — đó là vai trò mà ít ai dạy cho mình từ đầu. Chị đã từng ngồi ở vị trí đó, kẹp giữa sếp và team, không biết hôm nay nên cứng hay nên mềm. Chủ đề này gom lại những gì chị đã rút ra được.",
  story: {
    heading: "Quản lý là việc làm hàng ngày, không phải chức danh treo trên cửa",
    paragraphs: [
      "Hôm chị được giao team lần đầu, chị nhớ rất rõ cảm giác: vui và sợ song song. Vui vì được tin tưởng. Sợ vì biết mình chưa sẵn sàng — và sợ rằng mình sẽ làm hỏng cuộc đời nghề nghiệp của ai đó dưới quyền mình.",
      "Mấy tháng đầu chị làm tất cả mọi việc — vì sợ giao đi rồi không yên tâm. Rồi chị kiệt sức. Rồi chị học cách giao việc. Rồi chị học cách phản hồi khi nhân viên làm sai. Rồi chị học cách nói chuyện khi team không cùng nhịp.",
      "Không có công thức. Chỉ là từng bài học nhỏ, mỗi lần đi qua một tình huống. Chị viết lại ở đây những gì có thể giúp ai đó đang ở vị trí giống chị ngày xưa.",
    ],
  },
  topics: [
