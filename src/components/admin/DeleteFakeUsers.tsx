    ...
    <>
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.7)" }}>
          <div className="card-dark p-6 max-w-md w-full relative" style={{ border: "1px solid rgb(var(--danger-rgb) / 0.3)" }}>
            <button
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "rgb(var(--danger-rgb) / 0.15)" }}>
              ...
              <>
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    style={{ background: "rgb(var(--danger-rgb) / 0.15)", color: "var(--danger)", border: "1px solid rgb(var(--danger-rgb) / 0.4)" }}
                  >
                  ...
                  <button
                    ...
                    style={{ background: "var(--surface-2)", border: "1px solid #333" }}
                  >
                    Huỷ
                  </button>
                </div>
