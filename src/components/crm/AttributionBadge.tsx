import { Globe, Megaphone, Tag } from "lucide-react";
...
function SourceIcon({ source }: { source: string }) {
  ...
  if (lowerSource === "facebook" || lowerSource === "fb") {
    return (
      <svg
        width="12"
        height="12"
  ...
  if (lowerSource === "google" || lowerSource === "google_ads") {
    return (
      <svg
        width="12"
        height="12"
  ...
  if (lowerSource === "tiktok") {
    return (
      ...
      >
        <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.88 2.89 2.89 0 01-2.88-2.88 2.89 2.89 0 012.88-2.88c.28 0 .56.04.82.11V9.4a6.33 6.33 0 00-.82-.05A6.34 6.34 0 003.15 15.7a6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.34-6.34V9.72a8.16 8.16 0 004.76 1.52V7.79a4.85 4.85 0 01-1-.1z" />
      </svg>
    );
  }
