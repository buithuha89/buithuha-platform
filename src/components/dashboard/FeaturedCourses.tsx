        ...
        {courses.map((course) => {
          ...
          return (
            <Link
              ...
              className="card-dark group hover:bg-[var(--surface)] transition-all duration-200 overflow-hidden border border-transparent hover:border-[var(--accent)]/20"
            >
              {/* Thumbnail */}
              <div className="relative aspect-video bg-[var(--surface-2)] overflow-hidden">
                ...
                <div className="absolute top-2 left-2">
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-bold uppercase tracking-wide bg-[var(--accent)] text-black">
                    {course.badge_text}
                  </span>
                </div>
              </div>
              ...
              {/* Content */}
              <div className="p-3.5">
                <h4 className="text-sm font-semibold text-white group-hover:text-[var(--accent)] transition-colors line-clamp-2 leading-snug">
                  {product.title}
                </h4>
                ...
                <div className="flex items-center justify-between mt-3">
                  ...
                  <span className="text-[11px] text-[var(--accent)] flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
