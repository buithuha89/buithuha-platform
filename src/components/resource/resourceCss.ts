...
.rsc{--paper:#F7F3EC;--surf:#FFFDF9;--surf2:#F1EADD;--ink:#221E18;--muted:#6E6455;--faint:#9A8E7B;
--line:#E7DECE;--line2:#F0E9DB;--night:#14171C;
--gold:#CC8A22;--gold-b:#E4A93A;--gold-d:#A9741A;--gold-tint:#F6EAD1;--gold-line:#E7CE9C;--teal:#0C6070;
...
.rsc .top{background:var(--night);color:#F3EEE4;padding:15px 0}
...
.rsc .top a.brand small{display:block;font-weight:500;font-size:10.5px;color:#9A8F7D}
.rsc .top a.back{color:#C9C0B1;font-size:13.5px;text-decoration:none;font-weight:600;white-space:nowrap}
...
.rsc .card{background:var(--surf);border:1px solid var(--line);border-radius:16px;padding:24px 26px;margin-bottom:16px;box-shadow:0 20px 44px -34px rgba(34,30,24,.4)}
...
.rsc .ctaband{background:var(--night);color:#F3EEE4;border-radius:18px;padding:30px 28px;text-align:center;margin:8px 0 10px;position:relative;overflow:hidden}
.rsc .ctaband::before{content:"";position:absolute;left:50%;top:-80px;transform:translateX(-50%);width:400px;height:280px;background:radial-gradient(ellipse,rgba(224,169,58,.2),transparent 66%);pointer-events:none}
.rsc .ctaband>*{position:relative;z-index:1}
.rsc .ctaband h3{color:#fff;font-size:clamp(19px,2.6vw,24px);margin:0 0 8px}
.rsc .ctaband p{color:#C9C0B1;font-size:15px;max-width:54ch;margin:0 auto 18px}
.rsc .btn{display:inline-flex;align-items:center;gap:9px;justify-content:center;background:var(--gold-b);color:#231A08;font-weight:800;font-size:15.5px;padding:15px 30px;border-radius:999px;border:0;cursor:pointer;font-family:inherit;box-shadow:0 12px 30px rgba(204,138,34,.34);transition:transform .12s ease,background .15s ease;text-decoration:none}
.rsc .btn:hover{background:var(--gold);transform:translateY(-2px)}
...
.rsc-ov{position:fixed;inset:0;z-index:60;background:rgba(20,23,28,.6);backdrop-filter:blur(3px);display:flex;align-items:center;justify-content:center;padding:18px}
.rsc-modal{position:relative;width:100%;max-width:420px;background:#FFFDF9;border-radius:16px;padding:28px 26px;box-shadow:0 30px 80px rgba(0,0,0,.32);font-family:"Be Vietnam Pro",system-ui,sans-serif;color:#221E18}
.rsc-modal h3{margin:0 0 5px;font-size:20px;font-weight:800;letter-spacing:-.01em}
.rsc-modal .desc{margin:0 0 16px;font-size:14px;color:#6E6455}
.rsc-modal label{display:block;font-size:13px;font-weight:600;margin:0 0 5px}
.rsc-modal input{width:100%;padding:11px 13px;border:1px solid #E0D7C7;border-radius:8px;font-size:15px;margin-bottom:12px;font-family:inherit;color:#221E18;background:#fff}
.rsc-modal input:focus{outline:2px solid #CC8A22;outline-offset:1px;border-color:#CC8A22}
.rsc-modal .go{width:100%;background:#E4A93A;color:#231A08;border:0;padding:13px;border-radius:8px;font-weight:800;font-size:15px;cursor:pointer;font-family:inherit}
.rsc-modal .go:disabled{opacity:.6}
.rsc-modal .x{position:absolute;top:12px;right:14px;border:0;background:none;font-size:22px;cursor:pointer;color:#8A7F6D;line-height:1}
.rsc-modal .err{background:#FAEBDD;border:1px solid #ECCBA8;color:#B4530A;padding:9px 12px;border-radius:8px;font-size:13px;margin-bottom:12px}
.rsc-modal .ok{text-align:center;padding:12px 0}
.rsc-modal .ok .big{font-size:42px;line-height:1}
.rsc-modal .fine{color:#9A8E7B;font-size:12px;text-align:center;margin-top:8px}
